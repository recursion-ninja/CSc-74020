...
\midrule
\endhead
AdaBoost                      & \Qty{0.3249} & \Qty{0.4039} & \Qty{0.3021} & \Qty{0.3146} \\
...
\FigModelClassesTER{Logistic Regression}{22 - Logistic Regression.png}
\end{figure}

\newgeometry{left=1cm,right=1cm}
\begin{figure}[ht]
\caption{\label{fig:Class-Measure-TER-2}Model predictive performance of \TER classes (1)}
