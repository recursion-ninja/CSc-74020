...
\begin{center}
\textbf{\large Source code}\\[4mm]
Publicly available GitHub repository:\\[2mm]\href{https://github.com/recursion-ninja/CSc-74020}{\texttt{https://github.com/recursion-ninja/CSc-74020}}
\end{center}
...
We propose an exploration of an under-developed aspect of Dungeons and Dragons 5th Edition (\DnD), the monster "Challenge Rating" system.
...
\newcommand{\FigBoxedWidthTERC}{0.18\linewidth}
\newcommand{\FigExactWidthTERC}{28mm}
\newcommand{\FigModelClassesTERC}[2]{%
\FigModelClasses{\FigBoxedWidthTERC}{\FigExactWidthTERC}{#1}{#2}%
}%

\newcommand{\ColorbarTERC}{%
\begin{subfigure}[t]{8.25mm}
\raisebox{8.8mm}{\includegraphics[width=8.25mm]{Color-Bar-Legend.png}}
\end{subfigure}
}%
...
% |tier| = 22
%
\newcommand{\FigBoxedWidthTER}{0.18\linewidth}
\newcommand{\FigExactWidthTER}{33mm}
\newcommand{\FigModelClassesTER}[2]{%
\FigModelClasses{\FigBoxedWidthTER}{\FigExactWidthTER}{#1}{#2}%
}%
\newcommand{\ColorbarTER}{%
\begin{subfigure}[t]{8.25mm}
\raisebox{75.5mm}{\includegraphics[width=8.25mm]{Color-Bar-Legend.png}}
\end{subfigure}
}%
...
\FigModelClassesTER{K Nearest Neighbors}{22 - K Nearest Neighbors.png}\hfill
\ColorbarTER
\end{figure}
...
\FigModelClassesTER{Support Vector Machine}{22 - Support Vector Classification.png}\hfill
\ColorbarTER
\end{figure}
\restoregeometry
